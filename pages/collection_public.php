...
for ($n=$offset;(($n<count($collections)) && ($n<($offset+$per_page)));$n++)
	...
	<?php if (!$collection_public_hide_owner) { ?><td><?php echo highlightkeywords(htmlspecialchars($collections[$n]["fullname"]),$find)?></td><?php } ?>
